...
import {
  createSection, createVenueMap, deleteSection, generateSeats, getSectionSeats,
  getVenueMap, getVenueSections, setSeatState, updateSection, updateVenueMap,
} from '@/api/venue';
...
export default function PlanEditorScreen() {
  ...
  const edit = (patch: Partial<{ name: string; colour: string; ticketTypeId: string | null }>) =>
    setForm({ key: formKey, name, colour, ticketTypeId, ...patch });
  ...
  const choosePlan = async () => {
    ...
    try {
      ...
      const uploaded = await uploadVenuePlan(image.uri, organization.id);
